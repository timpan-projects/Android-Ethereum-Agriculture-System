...
public class RecordReadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_record_read);
    ...
    private void enableForegroundDispatch() {
        Intent intent = new Intent (this, RecordReadActivity.class);
    ...
    private void checkNFCfunction() {
        if (nfcAdapter == null || !nfcAdapter.isEnabled()){
            ...
            AlertDialog dialog = new AlertDialog.Builder(RecordReadActivity.this)
                    .setTitle("請開啟NFC功能")
    ...
    private void readTextFromMessage(NdefMessage ndefMessage) {
        ...
        if (ndefRecords != null && ndefRecords.length > 0) {
            ...
            Toast.makeText(this, "已讀取貨物，ID: " + tagContent, Toast.LENGTH_LONG).show();
            Intent i = new Intent(RecordReadActivity.this, RecordFinishActivity_style.class);
            i.putExtra("packageId", tagContent);
