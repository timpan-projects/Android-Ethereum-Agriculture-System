...
public class SplitSettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_go.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(SplitSettingsActivity.this, SplitWriteActivity.class);
    ...
    public class getFieldList extends AsyncTask<Object, Void, Void> {
        ...
        protected void onPostExecute(Void v) {
            ...
            ArrayAdapter adapter = new ArrayAdapter(SplitSettingsActivity.this, android.R.layout.simple_spinner_dropdown_item, list);
