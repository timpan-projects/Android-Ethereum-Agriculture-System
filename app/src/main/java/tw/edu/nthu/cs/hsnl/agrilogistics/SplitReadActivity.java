...
public class SplitReadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_split_read);
    ...
    private void enableForegroundDispatch() {
        Intent intent = new Intent (this, SplitReadActivity.class);
    ...
    private void checkNFCfunction() {
        if (nfcAdapter == null || !nfcAdapter.isEnabled()){
            ...
            AlertDialog dialog = new AlertDialog.Builder(SplitReadActivity.this)
                    .setTitle("請開啟NFC功能")
    ...
    private void readTextFromMessage(NdefMessage ndefMessage) {
        ...
        if (ndefRecords != null && ndefRecords.length > 0) {
            ...
            Toast.makeText(this, "已確認欲分裝貨物，ID: " + tagContent, Toast.LENGTH_LONG).show();
            Intent i = new Intent(SplitReadActivity.this, SplitSettingsActivity.class);
            i.putExtra("parentPackageId", tagContent);
