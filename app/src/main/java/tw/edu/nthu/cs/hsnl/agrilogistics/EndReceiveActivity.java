...
public class EndReceiveActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_end_recieve);
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(EndReceiveActivity.this, EndFinishActivity.class);
    ...
    private void enableForegroundDispatch() {
        Intent intent = new Intent (this, EndReceiveActivity.class);
    ...
    private void checkNFCfunction() {
        if (nfcAdapter == null || !nfcAdapter.isEnabled()){
            ...
            AlertDialog dialog = new AlertDialog.Builder(EndReceiveActivity.this)
                    .setTitle("請開啟NFC功能")
    ...
    private void readTextFromMessage(NdefMessage ndefMessage) {
        ...
        if (ndefRecords != null && ndefRecords.length > 0) {
            ...
            try {
                ...
                jObj.put("receiverId", "無(終點)");
            } catch (Exception e) {Log.d("JSON Exception", e.getMessage());}
            socket.emit("end package", jObj);
        }
        else {
